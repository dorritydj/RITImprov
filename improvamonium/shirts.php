...
<body>
	...
	<div class="improvamonium-title">
		<img src="../images/Improvamonium_Banner_1702x630.png" alt="Improvamonium 2015" style="width: 100%;" />
	</div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <p>We're currently establishing your shirt's base reality and justifying it so we can heighten your payment.</p>
              <div class="ajax-loader center"></div>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
	...
	<div class="container-fluid">
		...
		<div class="col-sm-offset-1 col-md-offset-1 col-lg-offset-1 col-md-10 col-lg-10 bg-white rnd-box" style="margin-top: -10%;">
			...
			<div class="row">
				...
				<br/><br/><br/>
				<div class="center">
					<button class="btn btn-info" style="font-size: 30px;" onclick="window.location='http://www.ritimprov.org/improvamonium'">Back to Improvamonium</button>
				</div>
			</div>
			...
			<div class="center">
				<img src="../images/improvamonium_2015_tshirt_front.png" alt="Improvamonium t-shirt Front" style="height: 40%; width: 40%; display: inline-block;" />
				<img src="../images/improvamonium_2015_tshirt_back.png" alt="Improvamonium t-shirt Back" style="height: 40%; width: 40%; display: inline-block; margin-left: 20px;" />
			</div>
			<br/><br/>
			...
			<form id="main_form">
				...
				<div class="row">
					...
					<div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
						<label for="team_name">Team Name (if applicable)</label>
